...
VENDOR_TEMPLATE_RULES = [
    {
        ...
        "family_match": {"source": "sysdescr", "operator": "contains", "values": ["WLX"]},
        "template_type": "atlib_identification",
        "template_name": "MSP - YAMAHA WLX Device Identification",
        "families": ["WLX"],
        "verified_models": [],
        "expected_identity": {
            "vendor": "confirmed",
        ...
        "scope": "network",
        "enabled": True,
        "notes": "Post-discovery only. Current exact sysObjectID map covers WLX212/413/222/322/323 from Yamaha primary documentation. Firmware is parsed from sysDescr when Rev.x is present; otherwise remains unknown.",
    },
    {
        "id": "yamaha-rtx",
        "name": "YAMAHA RTX",
        ...
        "match_operator": "contains",
        "match_value": "1.3.6.1.4.1.1182",
        "family_match": {"source": "sysdescr", "operator": "contains", "values": ["RTX"]},
        "template_type": "atlib_identification",
        "template_name": "MSP - YAMAHA RTX Device Identification",
        "families": ["RTX"],
        "verified_models": [],
        "expected_identity": {
            "vendor": "confirmed",
        ...
        "scope": "network",
        "enabled": True,
        "notes": "Post-discovery only: Yamaha enterprise + RTX in sysDescr. Firmware uses official Yamaha RT private MIB yrfRevision. Real-device validation required before production apply.",
    },
    {
        "id": "yamaha-swx",
        "name": "YAMAHA SWX",
